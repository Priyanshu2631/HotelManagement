...
#Declaring list for various options
name = []
phno = []
add = []
checkin = []
...
i = 0
# The Default Home function
def Home():
	print("\t\t\t\t\t\t WELCOME TO HOTEL RAYNES \n")
	print("\t\t\t 1 Booking\n")
	print("\t\t\t 2 Rooms Info\n")
...
def Booking():
		...
		ch=int(input("Enter your choice(0/1/2/3/4):"))
		# if-conditions to display allotted room type and it's price
		if ch==0:
			print(" 1. Standard Non-AC - Rs. 3500")
			print(" 2. Standard AC - Rs. 4000")
			print(" 3. 3-Bed Non-AC - Rs. 4500")
			print(" 4. 3-Bed AC - Rs. 5000")
			ch=int(input("Enter your room choice(1/2/3/4):"))
		if ch==1:
		...
		rn = k.randrange(40)+300
		cid = k.randrange(40)+10
		# checks if allotted room no. & customer id already not allotted
		while rn in roomno or cid in custid:
			rn = k.randrange(60)+300
			cid = k.randrange(60)+10
		rc.append(0)
		p.append(0)
		...
		custid.append(cid)
		i=i+1
		n=int(input("Press 0 to get back or exit\n"))
		if n==0:
			Home()
		else:
			exit()
...
def Rooms_Info():
	...
	print()
	n=int(input("Press 0 to continue:"))
	if n==0:
		Home()
	else:
		exit()
...
def restaurant():
	...
	for n in range(0,i):
		if custid[n]==ph and p[n]==0:
			...
			while(ch!=0):
				...
				ch=int(input("Enter your food choice:(Between 1 and 46):"))
	...
	n=int(input("Press 0 to continue else exit:"))
	if n==0:
		Home()
	else:
		exit()
...
def Payment():
	...
	if f==0:
		print("Invalid Customer Id")
	n = int(input("Press 0 to go back or exit\n"))
	if n == 0:
		Home()
	else:
		exit()
